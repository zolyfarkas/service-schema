...
public class ResolvingDecoder extends ValidatingDecoder {
   ...
   * @throws IOException
   */
  public static Object resolve(@Nonnull Schema writer, @Nonnull Schema reader)
    throws IOException {
   ...
   * <tt>null</tt> if there was no reordering of fields, i.e., if the correct thing for the reader to do is to read
   * (all) of its fields in the order specified by its own schema (useful for optimizations).
   */
