 ...
 * <P>
 * Note: Invoking close() on this class has no effect, and methods of this class can be called after the stream has
 * closed without generating an IOException.
 *
 * @author Herb Jellinek
 * @since JDK1.1
 */
public class CharArrayBuilder extends Writer {
   ...
   * <tt>null</tt>, then the four characters <tt>"null"</tt> are appended to this writer.
   *
   * @return This writer
   *
   * @since 1.5
   */
  public CharArrayBuilder append(CharSequence csq) {
   ...
   *
   * <p>
   * An invocation of this method of the form <tt>out.append(csq, start, end)</tt> when <tt>csq</tt> is not
   * <tt>null</tt>, behaves in exactly the same way as the invocation
   *
   * <pre>
   *     out.write(csq.subSequence(start, end).toString()) </pre>
   *
   * @param csq The character sequence from which a subsequence will be appended. If <tt>csq</tt> is <tt>null</tt>, then
   * characters will be appended as if <tt>csq</tt> contained the four characters <tt>"null"</tt>.
   *
