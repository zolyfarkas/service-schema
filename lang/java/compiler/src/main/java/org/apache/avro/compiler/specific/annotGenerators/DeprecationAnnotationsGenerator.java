 ...
 */
public class DeprecationAnnotationsGenerator implements JavaAnnotationsGenerator {
  ...
  public Set<String> generate(SpecificCompiler compiler, GenEntity entity, JsonProperties props,
    ...
    if (entity == GenEntity.FIELD && compiler.deprecatedFields()) {
      return Collections.singleton(Deprecated.class.getName());
    }
    if (props.getProp("deprecated") != null && entity != GenEntity.SETTER_ARG) {
      return Collections.singleton(Deprecated.class.getName());
    }
